...
class MIMIC3SyntheticDataset(MIMIC3RealDataset):
    ...
    def __init__(self,
        ...
        self.data = {
            ...
            # 'current_covariates': vitals[:, 1:, :], # for TCTCN
            # 'next_covariates': vitals[:, 2:, :], # for TCTCN
        }
...
class MIMIC3SyntheticDatasetCollection(SyntheticDatasetCollection):
    ...
    def __init__(self,
        ...
        logger.info(f'mean of the unscaled_outputs in the train_f: {np.mean(self.train_f.data["unscaled_outputs"])}')
